return {
  ...
  -- copilot-language-server
  {
    ...
    opts = function(_, opts)
      local sk = PithyVim.opts("sidekick.nvim") ---@type sidekick.Config|{}
  ...
  -- lualine
  {
    ...
    opts = function(_, opts)
      local icons = {
        ...
        Normal = { PithyVim.config.icons.kinds.Copilot, "Special" },
      }
...

  {
    ...
    keys = {
      ...
      { "<tab>", PithyVim.cmp.map({ "ai_nes" }, "<tab>"), mode = { "n" }, expr = true },
