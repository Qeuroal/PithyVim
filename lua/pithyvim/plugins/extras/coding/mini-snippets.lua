if pithyvim_docs then
  ...
  vim.g.pithyvim_mini_snippets_in_completion = true
...
local include_in_completion = vim.g.pithyvim_mini_snippets_in_completion == nil
  or vim.g.pithyvim_mini_snippets_in_completion
...
return {
  ...
  desc = "Manage and expand snippets (alternative to Luasnip)",
  {
    ...
    opts = function()
      ...
      PithyVim.cmp.actions.snippet_stop = function() end -- by design, <esc> should not stop the session!
      ---@diagnostic disable-next-line: duplicate-set-field
