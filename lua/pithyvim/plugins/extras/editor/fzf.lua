if pithyvim_docs then
  ...
  vim.g.pithyvim_picker = "fzf"
end

---@class FzfLuaOpts: pithyvim.util.pick.Opts
---@field cmd string?
...
local function symbols_filter(entry, ctx)
  if ctx.symbols_filter == nil then
    ctx.symbols_filter = PithyVim.config.get_kind_filter(ctx.bufnr) or false
  end
...
return {
  ...
  recommended = true,
  {
    ...
    opts = function(_, opts)
      ...
      -- Trouble
      if PithyVim.has("trouble.nvim") then
      ...
      config.defaults.actions.files["ctrl-r"] = function(_, ctx)
        ...
        PithyVim.pick.open(ctx.__INFO.cmd, o)
      end
      ...
      return {
        ...
        -- Custom PithyVim option to configure vim.ui.select
        ui_select = function(fzf_opts, items)
          return vim.tbl_deep_extend("force", fzf_opts, {
            ...
            winopts = {
              ...
              width = 0.5,
              preview = not vim.tbl_isempty(PithyVim.lsp.get_clients({ bufnr = 0, name = "vtsls" })) and {
                layout = "vertical",
    ...
    init = function()
      PithyVim.on_very_lazy(function()
        vim.ui.select = function(...)
          ...
          local opts = PithyVim.opts("fzf-lua") or {}
