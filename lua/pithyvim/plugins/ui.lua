return {
  -- This is what powers PithyVim's fancy-looking
    ...
    opts = {
      options = {
        ...
        get_element_icon = function(opts)
          return PithyVim.config.icons.ft[opts.filetype]
        end,
      },
    },
  ...
  -- statusline
  {
    ...
    opts = function()
      ...
      local icons = PithyVim.config.icons
        ...
        sections = {
          ...
          lualine_x = {
            -- stylua: ignore
            {
              ...
              color = function() return PithyVim.ui.fg("Statement") end,
            },
            -- stylua: ignore
            {
              function() return require("noice").api.status.mode.get() end,
              cond = function() return package.loaded["noice"] and require("noice").api.status.mode.has() end,
              color = function() return PithyVim.ui.fg("Constant") end,
            },
            -- stylua: ignore
            {
              function() return "  " .. require("dap").status() end,
              cond = function() return package.loaded["dap"] and require("dap").status() ~= "" end,
              color = function() return PithyVim.ui.fg("Debug") end,
            },
            -- stylua: ignore
            {
              require("lazy.status").updates,
              cond = require("lazy.status").has_updates,
              color = function() return PithyVim.ui.fg("Special") end,
            },
            {
              "diff",
              symbols = {
      ...
      if vim.g.trouble_lualine and PithyVim.has("trouble.nvim") then
