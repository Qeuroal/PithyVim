return {
  ...
  -- Better text-objects
  {
    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          i = PithyVim.mini.ai_indent, -- indent
          g = PithyVim.mini.ai_buffer, -- buffer
    ...
    config = function(_, opts)
      ...
      PithyVim.on_load("which-key.nvim", function()
        vim.schedule(function()
          PithyVim.mini.ai_whichkey(opts)
        end)
      end)
    end,
  },
