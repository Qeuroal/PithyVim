return {
  ...
  -- location.
  {
    ...
    keys = {
      ...
      -- { "<leader>k", mode = { "n", "x", "o" }, function () require("flash").jump({continue = true}) end, desc = "Flash jump a line" },
    },
  },
...

  {
    ...
    enabled = function()
      return PithyVim.pick.want() == "fzf"
    end,
  },
  {
    import = "pithyvim.plugins.extras.editor.telescope",
    enabled = function()
