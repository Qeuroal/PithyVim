  ...
  -- with the active keybindings of the command you started typing.
  {
    ...
    opts = {
      ...
      icons = {
        rules = {
          ...
          { pattern = "lowercase", icon = "󰬵 ", color = "blue" },
          { pattern = "uppercase", icon = "󰬶 ", color = "blue" },
          { pattern = "move", icon = "󰆾 ", color = "blue" },
          { pattern = "go to", icon = "󰆾 ", color = "blue" },
          { pattern = "prev end of word", icon = "󰆾 ", color = "blue" },
          { pattern = "first line", icon = "󰆾 ", color = "blue" },
          { pattern = "cycle backwards", icon = "󰆾 ", color = "blue" },
          { pattern = "open", icon = "󱥰 ", color = "purple" },
          { pattern = "select", icon = "󰒅 ", color = "blue" },
          { pattern = "add", icon = " ", color = "blue" },
          { pattern = "del", icon = " ", color = "blue" },
          { pattern = "replace", icon = " ", color = "blue" },
          { pattern = "del", icon = " ", color = "blue" },
    ...
    config = function(_, opts)
      ...
      if not vim.tbl_isempty(opts.defaults) then
        PithyVim.warn("which-key: opts.defaults is deprecated. Please use opts.spec instead.")
