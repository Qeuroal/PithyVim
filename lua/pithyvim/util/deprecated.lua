---@class pithyvim.util.deprecated
local M = {}
...
M.moved = {
  ...
  ui = {
    ...
    foldexpr = { "PithyVim.treesitter.foldexpr", stacktrace = false },
    fg = {
...
function M.decorate(name, mod)
  ...
  return setmetatable(mod, {
    __call = function(_, ...)
      ...
      PithyVim.deprecate("PithyVim." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        PithyVim.deprecate("PithyVim." .. name .. "." .. k, to, {
...
function M.lazygit()
  PithyVim.deprecate("PithyVim.lazygit", "Snacks.lazygit")
...
function M.toggle()
  PithyVim.deprecate("PithyVim.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
