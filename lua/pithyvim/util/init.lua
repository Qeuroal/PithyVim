...
---@class pithyvim.util: PithyUtilCore
---@field config PithyVimConfig
---@field treesitter pithyvim.util.treesitter
---@field lsp pithyvim.util.lsp
---@field root pithyvim.util.root
---@field terminal pithyvim.util.terminal
---@field format pithyvim.util.format
---@field plugin pithyvim.util.plugin
---@field extras pithyvim.util.extras
---@field inject pithyvim.util.inject
---@field news pithyvim.util.news
---@field json pithyvim.util.json
---@field lualine pithyvim.util.lualine
---@field mini pithyvim.util.mini
---@field pick pithyvim.util.pick
---@field cmp pithyvim.util.cmp
---@field deprecated pithyvim.util.deprecated
local M = {}
M.deprecated = require("pithyvim.util.deprecated")
...
function M.has_extra(extra)
  local Config = require("pithyvim.config")
  local modname = "pithyvim.plugins.extras." .. extra
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "PithyVim"
...
-- Safe wrapper around snacks to prevent errors when PithyVim is still installing
...
function M.set_default(option, value)
  ...
  local g = PithyVim.config._options[option] or vim.api.nvim_get_option_value(option, { scope = "global" })
